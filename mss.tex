...
\begin{lstlisting}[style=listingblock]
.preserves.astounds.regrets.ensoul
.repeats.about.receive.repulsed
\end{lstlisting}
...
In our iambic English wordlist, we achieve this like so:
...
\item
  ...
  supplementing trust-on-first-use for users who want to \texttt{ssh} into that
  server.
\item
